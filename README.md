...
-------
#### **О виджете** 
Виджет позволяет искать авиаперелеты как по одной конкретной компании так и по группе компаний. 
В карточке авиакомпании указаны названия точек вылета и прилета . а так же время вылета и прибытия. 
-------
